<?php
	session_start();
	if(($_SESSION['email'] == 'administrador@hotmail.com') || (isset($_SESSION['email'])))
	{
?>
<!DOCTYPE html>
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.3.1/js/bootstrap.min.js"></script>
	...
	<div id="fh5co-offcanvass" class="menu">
		...
		<ul>
			...
			<li class="active"><a href="enquete.php">Enquete</a></li>
		...
		<div id="fh5co-wrap">
			...
			<div id="fh5co-main">
				<div id="fh5co-products" data-section="products">
				    <div class="container"><h4 class='oferta'> ENQUETE</h4>
				    	<form name="menu" action="votar.php" method="POST">
						<div class="row">
							<div class="col-sm-12">
							...
							$query =mysqli_query($conexao,"select id, nome, marca, preco_venda, preco_promocao, categoria, foto, enquete from produtos order by nome");
							if (!$query)
							{
							...
							while($dados=mysqli_fetch_array($query))
										{						
											...
											{
												$id_prod = $dados['id'];
											$result_pg = " SELECT COUNT(id) AS num_result FROM enquete where id_produto = '$id_prod'";
						...
						?>
									 <div class="col-md-3 col-sm-6 col-xs-6 col-xxs-12">
									 	<div class="fh5co-figure to-animate" style="background-color: orange"> <!--  image-popup   ANIMAÇÃO DE TELA CHEIA -->
											<a href="produto.php?id=<?php echo $dados['id']; ?>">
													<?php
														echo "<h4 class='fh5co-figure-lead prod'>" .  $dados['nome'] . "</h4>";
													?>
												<figure>
													<img src="Setores/<?php echo $dados['categoria']; ?>/<?php echo $dados['foto']; ?>" class="img-responsive">
												</figure>
											</a>	
												<div class="votacao">
													<input type="radio" name="id_produto" class="votacao" value="<?php echo $dados['id']; ?>"><h4>Votar</h4>
													<?php
														
														echo "<g>R$" . $dados['preco_promocao'] . "</g><br>";
														echo "<gg>R$" . $dados['preco_venda']  . "</gg><br><voto>Votos " .$row_pg['num_result'] . "</voto><br>";	
											    	?>
											    </div>
											    <?php
											    	echo "<p class='fh5co-figure-lead'>" .  $dados['marca'] . "</p>";	
											    ?>
										</div>
								    </div>
		    						<?php
				    	...
				    	<div class="row text-center">
							<input type="submit" value="Votar" class="btn btn-login">
						</form>	
						<div>
				    ...
				    <div class="container"><h4 class='oferta text-left'> PRODUTOS EM OFERTA </h4>
						<div class="row">
							...
							<div class="paginas text-center">
								<?php
									echo "<a href='enquete.php?pagina=1'>&nbsp;Primeira&nbsp;</a>";
									...
									for ($pag_anterior=$pagina - $max_links; $pag_anterior <= $pagina - 1 ; $pag_anterior++) 
									{
										...
										if ($pag_anterior >= 1) 
										{
											echo "<a href='enquete.php?pagina=$pag_anterior'>&nbsp;$pag_anterior&nbsp;</a>";
										}
									...
									{ 
										...
										{
											echo "<a href='enquete.php?pagina=$pag_depois'>&nbsp;$pag_depois&nbsp;</a>";
										}
									}
									echo "<a href='enquete.php?pagina=$quantidade_pg'>&nbsp;Ultima&nbsp;</a>";
								?>
							</div>
