...
<!-- 		<h3 class="fh5co-lead">Connect with us</h3>
	...
	<div id="fh5co-page">
		<div id="fh5co-wrap">
			...
			<div class="container">
				<div class="col-sm-12">
					<form name="menu" action="produto_enviar.php" method="POST">
						<div class="row">
							<fieldset>
									...
									<fieldset class="col-sm-4">
										<legend class="text-center">Descrições</legend>
											<div class="row">
												...
												<div class="col-sm-4">
													<input name="nome" type="text" maxlength="50" size="30" required="nome">
												</div>
											</div>
											...
											<div class="row">
												...
												<div class="col-sm-4">
													<input name="marca" type="text" maxlength="50" size="30" required="marca">	
												</div>
											</div>
									...
									<fieldset class="col-sm-4">
										<legend class="text-center">Estoque & Preços</legend>
											<div class="row">
												...
												<div class="col-sm-5">
													<input name="preco_venda" type="number"  step="0.01" maxlength="5" size="5" required="preco_venda" style="width: 130px;">
												</div>
											</div>
											...
											<div class="row">
												...
												<div class="col-sm-3">
													<input name="preco_promocao" type="number"  step="0.01" maxlength="5" size="5" required="preco_promocao" style="width: 130px;">
												</div>
											</div>
											<div class="row">
											...
											<div class="row">
												...
												<div class="col-sm-4">
													<input name="estoque" type="number"  step="0.01" maxlength="5" size="5" required="estoque" style="width: 130px;">
												</div>
											</div>
											...
											<div class="row">
												...
												<div class="col-sm-4">
													<input name="estoque_min" type="number"  step="0.01" maxlength="5" size="5" required="estoque_min" style="width: 130px;">
												</div>
											</div><br>
									</fieldset>
						...
						<fieldset>
							<legend>Informações Adicionais</legend>
								...
								<div class="row">
									<div class="col-sm-6">
										<textarea id="ingredientes" cols="50" rows="6" name="ingredientes" maxlength="300" placeholder="Ingredientes do Produto"></textarea>
									</div>
									<div class="col-sm-5">
										<textarea id="nutricional" cols="50" rows="4" name="nutricional" maxlength="200" placeholder="Informaçoes Nutricionais"></textarea>
									</div>
								</div>
						</fieldset>
						<center>
